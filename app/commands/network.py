...
def network_command() -> str:
    ...
    result += f" Donnees envoyees: {net_io.bytes_sent // (2**20)}MO\n"
    result += f" Donnees reçues: {net_io.bytes_recv // (2**20)}MO\n\n"
    
    result += "🔌 Interfaces réseau :\n"
...
def ports_command() -> str:
    ...
    result = "🔌 Ports actifs :\n\n"
    result += f"{'protocole:':<10} {'adress Locale ':<25} {'PID':<10} {'Programme'}\n"
    result += "-"* 80 + "\n"
